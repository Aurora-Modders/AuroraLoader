...
namespace AuroraLoader
{
    class Multiplayer
    {
        ...
        {
            var folder = Path.Combine(Path.GetDirectoryName(Process.GetCurrentProcess().MainModule.FileName), "Multiplayer");
        ...
        {
            var folder = Path.Combine(Path.GetDirectoryName(Process.GetCurrentProcess().MainModule.FileName), "Multiplayer", name);
