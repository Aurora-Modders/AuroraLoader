...
namespace AuroraLoader.Registry
{
    ...
    public class ModRegistry : IRegistry
    {
        ...
        public void UpdateAuroraLoader(Mod mod)
        {
            ...
            InstallOrUpdate(mod);
            File.Copy(Path.Combine(mod.Installation.ModFolder, mod.Name, mod.Installation.Version.ToString(), mod.Installation.ExecuteCommand), Path.Combine(Program.AuroraLoaderExecutableDirectory, mod.Installation.ExecuteCommand));
        }
